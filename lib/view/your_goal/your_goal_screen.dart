...
class _YourGoalScreenState extends State<YourGoalScreen> {
  int selectedIndex = 0; // Track selected goal
              ...
              child: CarouselSlider(
                items: pageList
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: pageList[selectedIndex]["title"] == obj["title"]
                            ? Colors.white
                            : Colors.transparent,
                        width: 3, // Highlight selected goal
                      ),
                    ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RoundGradientButton(
                      title: "Confirm",
                      onPressed: () async {
                        String goal = pageList[selectedIndex]["title"]!;
                        await AuthService().storeUserData(widget.userData, goal);
